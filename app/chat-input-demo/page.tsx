...
const ClaudeChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    <div
      className="h-dvh overflow-y-auto relative w-full max-w-2xl mx-auto"
...
export default function Component() {
  ...
  const handleSendMessage = async (
    ...
    for (const fileWithPreview of files) {
      ...
      if (file.type.startsWith('image/')) {
        ...
        // For textual files, use blob URL
        const blobUrl = URL.createObjectURL(file);
    ...
    // Combine message with pasted content
  ...
  return (
    <div className="h-screen overflow-y-auto w-screen bg-[#262624] flex flex-col p-4">
      <div className="w-full max-w-4xl mx-auto flex-1 flex flex-col">
        {messages.length === 0 ? (
          ...
          <div className="flex-1 h-[80dvh] overflow-y-auto space-y-4 py-8" style={{ overflowY: 'auto' }}>
